...
- pm2: `pm2 restart ink2task-ticktick`
- systemd (Linux/Pi): `sudo systemctl restart ink2task-ticktick`
- macOS LaunchAgent: `launchctl kickstart -k gui/$(id -u)/com.ink2task.ticktick`
