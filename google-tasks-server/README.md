...
- pm2: `pm2 restart ink2task-google`
- systemd (Linux/Pi): `sudo systemctl restart ink2task-google`
- macOS LaunchAgent: `launchctl kickstart -k gui/$(id -u)/com.ink2task.google`
